...
const golok_1 = __importDefault(require("../core/golok"));
class GolokCLI {
    constructor() {
        // Initiate commander
        ...
        program
            ...
            .option('-o, --output <string>', 'Destination folder for generated apps', 'currentDirname')
            ...
            const golok = new golok_1.default({ path: blueprintPath });
