...
// ---------------------------
//const  plain = utils.parseYaml('/Users/bhangun/workopen/golok/lib/core/../../example/standard.yaml');
/* const  plain = utils.parseYaml("/Users/bhangun/Dropbox (Personal)/jdl/Business/Niagapos/mypos.yaml")
// console.log(model);

const model = utils.transpile(plain);
...
const word = str.substr('required');
console.log('-1-', str.substr(str.indexOf(word)));
console.log('-2-',str.indexOf(word));
console.log('-3-',str.substr(str.indexOf(word) + word.length));

const str1 = '"SELECT_100E_7",24';
const koma = str.substr(str.indexOf('=') + 1);
console.log(koma);
