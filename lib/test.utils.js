...
import {typeCheck, copyFile, makeDir, titleCase, capitalize, parseYaml,
  checkFileExt, camelToTitle} from '../lib/core/utils.js';


const  model = parseYaml('/Users/bhangun/workopen/golok/lib/core/../../example/contoh.yaml');
console.log(model);
