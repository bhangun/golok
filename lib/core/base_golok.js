    ...
    this.program.command('create')
        ...
        .action((modelPath, options) => {
          ...
          try {
            ...
            if (options.jdl) {
              transpileJDL(this.config.model, this.config.options.output, this.__dirname);
              utils.print('JDL file created.');
            }

            if (options.jdljson) {
              transpileJDLJson(this.config.model, this.config.options.output);
            }
