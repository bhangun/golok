import {
    typeCheck, parseYaml, removeWhitespace,
    splitString, extractLocale
} from './utils.js';
        ...
        if (yaml.includes) {
            ...
            yaml.includes.forEach((el) => {
                ...
                if(options){
                    ...
                    _path = yaml.info.blueprintSourceDir +'/'+ el.file;
                }
                ...
                if (_yaml.entities) {
                    ...
                    if (el.entities) {
                        ...
                        _entities = _yaml.entities.concat(_yaml.entities);
