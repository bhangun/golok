...
export default class Entities {
    constructor(yaml, defaultProp /* name, properties, relationship, nameTitleCase, nameCamelCase, nameSnakeCase */) {
      /* this.name = name;
      ...
      yaml.entities = this.mappingEntity(yaml, defaultProp);
  ...
  /* 
    ...
    setTitleCase(nameTitleCase) {
      this.nameTitleCase = nameTitleCase;
    }
  
    setCamelCase(nameCamelCase) {
      this.nameCamelCase = nameCamelCase;
    }
 ...
 */
    ...
    */
    ...
    typeParsing(prop, relationship, relation,  model) {
        ...
        prop = convertTypeDart(prop, prop.ref?
