export {JDL, JDLField, JDLRelationship};
...
class JDL {
  /**
    ...
    * @param {string} dto
     */
  constructor(changelogDate, entityTableName, fields, name,
      pagination='pagination',
      readOnly, relationships, searchEngine,
      service='serviceImpl', dto='mapstruct') {
...
class JDLRelationship {
  /**
    ...
    * @param {string} relationshipType
     */
  constructor(otherEntityField, otherEntityName, otherEntityRelationshipName,
